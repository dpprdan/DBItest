...
- Ci: Harden `workflow_run` workflows against untrusted pull requests
  ([\#106](https://github.com/r-dbi/DBItest/issues/106)).

- Ci: Pin third-party actions to commits and let Renovate keep them
  pinned ([\#105](https://github.com/r-dbi/DBItest/issues/105)).

## DBItest 1.8.3.9004 (2026-08-05)

### Chore

- Auto-update from GitHub Actions
  ([\#554](https://github.com/r-dbi/DBItest/issues/554)).
...
- Ci: Pass workflow context through the environment, not into script
  text ([\#102](https://github.com/r-dbi/DBItest/issues/102)).
...
- Replace legacy `PST8PDT` time zone with `America/Los_Angeles` in
  roundtrip tests
  ([\#540](https://github.com/r-dbi/DBItest/issues/540)).
...
- CRAN release v1.8.3
  ([\#536](https://github.com/r-dbi/DBItest/issues/536)).
