...
- tweaks:
  ...
  [`tweaks()`](https://dbitest.r-dbi.org/reference/tweaks.md) function.
...
- default_skip:
  ...
  [`test_all()`](https://dbitest.r-dbi.org/reference/test_all.md) and
...
#> Arguments:
#> $dbname
#> [1] "/tmp/RtmpZNV8fG/DBItest27794c109935.sqlite"
#> 
#> 
#> $drv
#> <SQLiteDriver>
